 ...
 * 农历1949-2100年查询表
 * 解释下数组里的十六进制数表示什么
 * 以0x0b557为例，16进制转化为2进制为：0000 1011 0101 0101 0111
 * 最后一位表示该年的闰月，7则表示闰7月，为0的话表示没有闰月
 * 中间的b55代表了天数，0表示29天，1表示30天
 * 所以该年1-12月的月份天数分别为：30、29、30、30、29、30、29、30、29、30、29、30
 * 如果有闰月，开头的0则表示29天，1表示30天，否则没有意义
 */
let lunarYearArr = [
    0x0b557, //1949
